...
// The map page is shipped to users (nothing under references/ is excluded by
// .clawhubignore), so a command printed in its UI is as user-facing as one in SKILL.md —
